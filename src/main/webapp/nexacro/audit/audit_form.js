// 감사 로그 Nexacro 화면 스크립트
// AI 분석 포인트: 화면 transaction -> Controller -> Service -> Mapper -> TBAUDITLOG.ACTIONNM
var auditForm = {};

auditForm.oninit = function() {
...
auditForm.fn_search = function(instCdList, baseDate) {
    this.lastTransactionId = "search_audit";
    ...
    this.transaction(
        "analyzeAuditMismatch",
        "/audit/analyzeMismatch.do",
        "dsSearch=dsSearch",
        "dsMismatch=dsMismatch",
        "",
        "auditForm.fn_callback"
    );
};

auditForm.fn_submit = function(id, actorId) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
...
auditForm.fn_changeName = function(id, newName, actorId, syncYn) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
    this.dsSearch.setColumn(row, "ID", id);
...
auditForm.fn_callback = function(svcId, errCd, errMsg) {
    if (errCd < 0) {
...
auditForm.fn_renderMismatchGrid = function() {
...
auditForm.fn_validateRule1 = function(row) {
...
auditForm.fn_validateRule2 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule3 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule4 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule5 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule6 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule7 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule8 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule9 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule10 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule11 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule12 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule13 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule14 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule15 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule16 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_validateRule17 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
auditForm.fn_addMessage = function(level, message) {
