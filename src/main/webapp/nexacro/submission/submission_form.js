// 조사 제출 관리 Nexacro 화면 스크립트
// AI 분석 포인트: 화면 transaction -> Controller -> Service -> Mapper -> TBINSTSURV.CHARGE
var submissionForm = {};

submissionForm.oninit = function() {
...
submissionForm.fn_search = function(instCdList, baseDate) {
    this.lastTransactionId = "search_submission";
    ...
    this.transaction(
        "analyzeSubmissionMismatch",
        "/submission/analyzeMismatch.do",
        "dsSearch=dsSearch",
        "dsMismatch=dsMismatch",
        "",
        "submissionForm.fn_callback"
    );
};

submissionForm.fn_submit = function(id, actorId) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
...
submissionForm.fn_changeName = function(id, newName, actorId, syncYn) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
    this.dsSearch.setColumn(row, "ID", id);
    ...
    this.transaction(
        "changeSubmissionName",
        "/submission/changeName.do",
        "dsSearch=dsSearch",
        "dsResult=dsResult",
        "",
        "submissionForm.fn_callback"
...
submissionForm.fn_callback = function(svcId, errCd, errMsg) {
    if (errCd < 0) {
...
submissionForm.fn_renderMismatchGrid = function() {
...
submissionForm.fn_validateRule1 = function(row) {
...
submissionForm.fn_validateRule2 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule3 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule4 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule5 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule6 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule7 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule8 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule9 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule10 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule11 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule12 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule13 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule14 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule15 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule16 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_validateRule17 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
submissionForm.fn_addMessage = function(level, message) {
