// 알림 발송 Nexacro 화면 스크립트
// AI 분석 포인트: 화면 transaction -> Controller -> Service -> Mapper -> TBNOTIFY.RECEIVERNM
var notificationForm = {};

notificationForm.oninit = function() {
...
notificationForm.fn_search = function(instCdList, baseDate) {
    this.lastTransactionId = "search_notification";
    ...
    this.transaction(
        "analyzeNotificationMismatch",
        "/notification/analyzeMismatch.do",
        "dsSearch=dsSearch",
        "dsMismatch=dsMismatch",
        "",
        "notificationForm.fn_callback"
    );
};

notificationForm.fn_submit = function(id, actorId) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
...
notificationForm.fn_changeName = function(id, newName, actorId, syncYn) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
    this.dsSearch.setColumn(row, "ID", id);
...
notificationForm.fn_callback = function(svcId, errCd, errMsg) {
    if (errCd < 0) {
...
notificationForm.fn_renderMismatchGrid = function() {
...
notificationForm.fn_validateRule1 = function(row) {
...
notificationForm.fn_validateRule2 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule3 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule4 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule5 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule6 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule7 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule8 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule9 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule10 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule11 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule12 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule13 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule14 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule15 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule16 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_validateRule17 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
notificationForm.fn_addMessage = function(level, message) {
