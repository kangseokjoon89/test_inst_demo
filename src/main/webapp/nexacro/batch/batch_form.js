// 배치 동기화 Nexacro 화면 스크립트
// AI 분석 포인트: 화면 transaction -> Controller -> Service -> Mapper -> TBBATCHLOG.JOBNM
var batchForm = {};

batchForm.oninit = function() {
...
batchForm.fn_search = function(instCdList, baseDate) {
    this.lastTransactionId = "search_batch";
    ...
    this.transaction(
        "analyzeBatchMismatch",
        "/batch/analyzeMismatch.do",
        "dsSearch=dsSearch",
        "dsMismatch=dsMismatch",
        "",
        "batchForm.fn_callback"
    );
};

batchForm.fn_submit = function(id, actorId) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
...
batchForm.fn_changeName = function(id, newName, actorId, syncYn) {
    this.dsSearch.clearData();
    var row = this.dsSearch.addRow();
    this.dsSearch.setColumn(row, "ID", id);
...
batchForm.fn_callback = function(svcId, errCd, errMsg) {
    if (errCd < 0) {
...
batchForm.fn_renderMismatchGrid = function() {
...
batchForm.fn_validateRule1 = function(row) {
...
batchForm.fn_validateRule2 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule3 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule4 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule5 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule6 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule7 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule8 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule9 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule10 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule11 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule12 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule13 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule14 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule15 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule16 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_validateRule17 = function(row) {
    var instCd = this.dsSearch.getColumn(row, "INSTCD");
    var name = this.dsSearch.getColumn(row, "NAME");
    var status = this.dsSearch.getColumn(row, "STATUS");
    if (instCd == null || instCd == '') {
...
batchForm.fn_addMessage = function(level, message) {
