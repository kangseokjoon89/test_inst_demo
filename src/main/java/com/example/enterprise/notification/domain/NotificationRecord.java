package com.example.enterprise.notification.domain;
 ...
 * 연결 테이블: TBNOTIFY, 대표 컬럼: RECEIVERNM
 */
public class NotificationRecord {
    ...
    public static NotificationRecord of(String id, String instCd, String userId, String name) {
