package com.example.enterprise.notification.controller;

import com.example.enterprise.notification.service.NotificationService;
...
public class NotificationController {
    ...
    public Map<String, Object> healthCheckStep1() {
        ...
        response.put("step", 1);
        response.put("table", "TBNOTIFY");
        response.put("column", "RECEIVERNM");
