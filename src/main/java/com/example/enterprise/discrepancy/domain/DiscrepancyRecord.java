package com.example.enterprise.discrepancy.domain;
 ...
 * 연결 테이블: TBDISCREPANCY, 대표 컬럼: REASON
 */
public class DiscrepancyRecord {
    ...
    public static DiscrepancyRecord of(String id, String instCd, String userId, String name) {
