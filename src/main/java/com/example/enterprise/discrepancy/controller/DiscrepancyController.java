package com.example.enterprise.discrepancy.controller;

import com.example.enterprise.discrepancy.service.DiscrepancyService;
...
public class DiscrepancyController {
    ...
    public DiscrepancyController(DiscrepancyService service) {
    ...
    public Map<String, Object> healthCheckStep1() {
        Map<String, Object> response = new LinkedHashMap<>();
        response.put("module", "discrepancy");
        response.put("step", 1);
        response.put("table", "TBDISCREPANCY");
        response.put("column", "REASON");
