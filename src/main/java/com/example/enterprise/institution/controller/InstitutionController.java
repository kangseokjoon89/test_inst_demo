package com.example.enterprise.institution.controller;

import com.example.enterprise.institution.service.InstitutionService;
...
public class InstitutionController {
    ...
    public Map<String, Object> healthCheckStep1() {
        Map<String, Object> response = new LinkedHashMap<>();
        response.put("module", "institution");
        response.put("step", 1);
        response.put("table", "TBINST");
        response.put("column", "INSTNM");
