package com.example.enterprise.institution.domain;
...
public class InstitutionRecord {
    ...
    public static InstitutionRecord of(String id, String instCd, String userId, String name) {
        InstitutionRecord record = new InstitutionRecord();
        record.id = id;
