package com.example.enterprise.submission.domain;
 ...
 * 연결 테이블: TBINSTSURV, 대표 컬럼: CHARGE
 */
public class SubmissionRecord {
    ...
    public static SubmissionRecord of(String id, String instCd, String userId, String name) {
