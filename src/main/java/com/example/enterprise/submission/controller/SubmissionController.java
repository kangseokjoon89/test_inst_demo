package com.example.enterprise.submission.controller;

import com.example.enterprise.submission.service.SubmissionService;
...
public class SubmissionController {
    ...
    public Map<String, Object> healthCheckStep1() {
        Map<String, Object> response = new LinkedHashMap<>();
        response.put("module", "submission");
        response.put("step", 1);
        response.put("table", "TBINSTSURV");
        response.put("column", "CHARGE");
