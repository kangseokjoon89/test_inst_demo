package com.example.enterprise.charge.domain;
 ...
 * 연결 테이블: TBCHARGEHIST, 대표 컬럼: CHARGENM
 */
public class ChargeRecord {
    ...
    public static ChargeRecord of(String id, String instCd, String userId, String name) {
