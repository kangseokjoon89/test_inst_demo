package com.example.enterprise.batch.controller;

import com.example.enterprise.batch.service.BatchService;
...
public class BatchController {
    ...
    public Map<String, Object> healthCheckStep1() {
        Map<String, Object> response = new LinkedHashMap<>();
        response.put("module", "batch");
        response.put("step", 1);
        response.put("table", "TBBATCHLOG");
        response.put("column", "JOBNM");
