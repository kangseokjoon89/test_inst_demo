package com.example.enterprise.approval.controller;

import com.example.enterprise.approval.service.ApprovalService;
...
public class ApprovalController {
    ...
    public Map<String, Object> healthCheckStep1() {
        Map<String, Object> response = new LinkedHashMap<>();
        response.put("module", "approval");
        response.put("step", 1);
        response.put("table", "TBAPPROVAL");
        response.put("column", "APPROVERNM");
