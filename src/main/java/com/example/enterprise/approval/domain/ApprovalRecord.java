package com.example.enterprise.approval.domain;
 ...
 * 연결 테이블: TBAPPROVAL, 대표 컬럼: APPROVERNM
 */
public class ApprovalRecord {
    ...
    public static ApprovalRecord of(String id, String instCd, String userId, String name) {
