package com.example.enterprise.report.controller;

import com.example.enterprise.report.service.ReportService;
...
public class ReportController {
    ...
    public Map<String, Object> healthCheckStep1() {
        ...
        response.put("step", 1);
        response.put("table", "TBREPORT");
        response.put("column", "REPORTNM");
