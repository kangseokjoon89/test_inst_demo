package com.example.enterprise.report.domain;
 ...
 * 연결 테이블: TBREPORT, 대표 컬럼: REPORTNM
 */
public class ReportRecord {
    ...
    public static ReportRecord of(String id, String instCd, String userId, String name) {
