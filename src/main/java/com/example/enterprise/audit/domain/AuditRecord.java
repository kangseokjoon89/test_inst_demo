package com.example.enterprise.audit.domain;
 ...
 * 연결 테이블: TBAUDITLOG, 대표 컬럼: ACTIONNM
 */
public class AuditRecord {
    ...
    public static AuditRecord of(String id, String instCd, String userId, String name) {
