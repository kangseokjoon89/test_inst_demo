package com.example.enterprise.audit.controller;

import com.example.enterprise.audit.service.AuditService;
...
public class AuditController {
    ...
    public Map<String, Object> healthCheckStep1() {
        ...
        response.put("step", 1);
        response.put("table", "TBAUDITLOG");
        response.put("column", "ACTIONNM");
