package com.example.enterprise.survey.domain;
 ...
 * 연결 테이블: TBSURVEY, 대표 컬럼: SURVEYNM
 */
public class SurveyRecord {
    ...
    public static SurveyRecord of(String id, String instCd, String userId, String name) {
