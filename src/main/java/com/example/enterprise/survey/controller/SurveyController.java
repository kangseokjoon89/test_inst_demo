package com.example.enterprise.survey.controller;

import com.example.enterprise.survey.service.SurveyService;
...
public class SurveyController {
    ...
    public Map<String, Object> healthCheckStep1() {
        Map<String, Object> response = new LinkedHashMap<>();
        response.put("module", "survey");
        response.put("step", 1);
        response.put("table", "TBSURVEY");
        response.put("column", "SURVEYNM");
