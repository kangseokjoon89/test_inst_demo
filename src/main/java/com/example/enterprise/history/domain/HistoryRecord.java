package com.example.enterprise.history.domain;
 ...
 * 연결 테이블: TBHISTORY, 대표 컬럼: CHANGEDESC
 */
public class HistoryRecord {
    ...
    public static HistoryRecord of(String id, String instCd, String userId, String name) {
