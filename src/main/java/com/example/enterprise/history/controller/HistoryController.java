package com.example.enterprise.history.controller;

import com.example.enterprise.history.service.HistoryService;
...
public class HistoryController {
    ...
    public Map<String, Object> healthCheckStep1() {
        Map<String, Object> response = new LinkedHashMap<>();
        response.put("module", "history");
        response.put("step", 1);
        response.put("table", "TBHISTORY");
        response.put("column", "CHANGEDESC");
